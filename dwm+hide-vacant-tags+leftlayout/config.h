...
static const char *fonts[] = { "SF Pro Display:style=Medium:size=10:antialias=true:autohint=true", "Font Awesome 5 Free Solid:size=12:antialias=true:autohint=true" };
